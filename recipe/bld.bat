...
copy %LIBRARY_PREFIX%\bin\wish90.exe %LIBRARY_PREFIX%\bin\wish.exe
copy %LIBRARY_PREFIX%\bin\tclsh90.exe %LIBRARY_PREFIX%\bin\tclsh.exe

:: No `t` version of wish86.exe
copy %LIBRARY_PREFIX%\bin\wish90.exe %LIBRARY_PREFIX%\bin\wish90.exe
copy %LIBRARY_PREFIX%\bin\tclsh90.exe %LIBRARY_PREFIX%\bin\tclsh90.exe
popd
